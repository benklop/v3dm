...
possible to use v3dm to visualize PLY files or Wavefront's OBJ files,
depending on the formatter/viewer you choose.

A known flaw is that it doesn't enforce to use a valid formatter for the
extensions configured in a field. It's up to the site builder to guarantee
the consistency: ie, choose a set of extensions you know are recognized by
